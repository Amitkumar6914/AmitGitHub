...
public class Verify_All_Products_and_product_detail {
	...
	public void  Verify_home_page() throws InterruptedException {
		...
		driver.findElement(By.xpath("//section[@style='height: auto !important;']/div/div[1]/div[2]/div/div[2]/div/div[2]/ul")).click();
